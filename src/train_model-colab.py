...
train_data_path = "/content/drive/MyDrive/Colab Notebooks/trocr_data/training_data"
train_paths, train_labels = load_image_labels(train_data_path)
# validation
# val_data_path   = "datasets/data/validation_data"
val_data_path = "/content/drive/MyDrive/Colab Notebooks/trocr_data/validation_data"
val_paths, val_labels     = load_image_labels(val_data_path)
# testing
# test_data_path  = "datasets/data/testing_data"
test_data_path = "/content/drive/MyDrive/Colab Notebooks/trocr_data/testing_data"
...
training_args = Seq2SeqTrainingArguments(
    output_dir = "/content/drive/MyDrive/Colab Notebooks/trocr-finetuned",
    per_device_train_batch_size=1,
    per_device_eval_batch_size=1,
    predict_with_generate=True,
    logging_steps=10, # Log training metrics (to the console)
    save_steps=50, # Save a checkpoint
    eval_strategy="steps", # "eval", NOT "evaluation"
    eval_steps=50,
    num_train_epochs=2, # Number of times to iterate through the dataset
    fp16=True,  # True = Half-precision -> faster with less memory on GPU
